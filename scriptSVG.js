...
======================= */
const bounds = [
  [46.5970, 1.5990], // à ajuster si besoin
  [46.5988, 1.6005]
];
...
function checkFinal() {
  ...
  if (success) revealSecret();
  else alert("❌ Certaines réponses sont fausses !");
}
